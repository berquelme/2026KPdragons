    ...
    <div className="max-w-5xl mx-auto px-4 py-12 animate-hero">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div>
            <h2 className="text-5xl font-kids text-slate-900 mb-4 uppercase">
              REACH THE {teamData.shortName}
            </h2>
            <p className="text-slate-500 font-medium italic">
              Have a question for our team leaders? We're here to help!
            </p>
          </div>
          ...
          <div className="bg-slate-900 rounded-[40px] p-8 text-white relative overflow-hidden group shadow-2xl">
            ...
            <div className="relative z-10">
              <h3 className="font-kids text-2xl mb-6 flex items-center gap-2 uppercase">
                <span className="material-symbols-outlined text-yellow-400">map</span>
                {teamData.homeFieldTitle || 'OUR GROUND'}
              </h3>
              <div className="space-y-4">
                <div>
                ...
                <button 
                  type="button"
                  className="flex items-center gap-2 text-yellow-400 text-sm font-bold border-b border-yellow-400/20 pb-1 hover:gap-3 transition-all"
                >
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-[48px] p-10 shadow-2xl border border-slate-100 relative overflow-hidden">
            ...
            <div className="mb-10">
              <h3 className="font-kids text-3xl text-slate-900 uppercase">SEND A MESSAGE</h3>
              <p className="text-slate-400 text-sm mt-2">Expect a reply back within 24 hours!</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {['General Question', 'Collaborate', 'Absence', 'Other'].map(sub => (
                    <button
                      key={sub}
                      type="button"
              ...
              >
                ...
                {formState === 'sent' && (
                  <>MESSAGE DELIVERED! <span className="material-symbols-outlined">check_circle</span></>
                )}
                {formState === 'error' && (
              ...
              <p className="text-center text-[9px] text-slate-300 font-bold uppercase tracking-[0.3em]">
                Your privacy is important to our team.
              </p>
            </form>
          </div>
        </div>
