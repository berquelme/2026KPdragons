...
export const PlayerCard: React.FC<PlayerCardProps> = ({ player }) => {
  // Compute real match stats dynamically from MATCHES_DATA (Derived State)
  ...
  const playerPhoto = (player as any).image || (player as any).photo;
  ...
  return (
    <div className="group relative bg-white rounded-[40px] p-8 border-2 border-slate-100 hover:border-[#E53935]/20 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
      ...
      {/* Player Photo or Silhouette Placeholder */}
